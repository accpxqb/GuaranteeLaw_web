							...
							<div class="single-post">
								...
								<div class="blog_details">
									...
									<ul class="blog-info-link mt-3 mb-4">
										...
										<li><i class="fa fa-comments"></i>{{detail.Clicks}}</li>
										<li><i class="fa fa-calendar-times"></i>{{detail.CreateTime?.split('T')[0]}}</li>
									</ul>
