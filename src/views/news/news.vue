										...
										<form action="#" class="filter__form">
											<div class="filter__item last__item">
												...
												<div class="filter__item__input">
													<el-select class="nice-select" v-model="formInline.Menuid" clearable
														placeholder="请选择">
														<el-option v-for="item in menuList" :label="item.Menutitle"
															:value="item.Menuid" :key="item.Menuid">
															{{ item.Menutitle }}
														</el-option>
											...
											<div class="filter__item">
												<h5>文章标题</h5>
												<div class="filter__item__input">
													<el-input v-model="formInline.Title" placeholder="请输入您要检索的文章标题"
														clearable />
												</div>
											</div>
											<div class="filter__item">
												<h5>文章内容</h5>
												<div class="filter__item__input">
													<el-input v-model="formInline.Content" placeholder="请输入您要检索的文章内容"
														clearable />
												</div>
											</div>
									...
									<el-col :span="6">
										<div class="blog_right_sidebar">
											...
											<aside class="single_sidebar_widget popular_post_widget">
												<h3 class="widget_title">热门行业动态</h3>
