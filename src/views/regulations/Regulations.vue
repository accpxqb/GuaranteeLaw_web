									...
									<el-col :span="24">
										<form action="#" class="filter__form">
											...
											<div class="filter__item">
												<h5>法律名称</h5>
												<div class="filter__item__input">
													<el-input v-model="formInline.LegalName" placeholder="请输入您要检索的法律名称"
														clearable />
												</div>
											</div>
											<div class="filter__item">
												<h5>文献内容</h5>
												<div class="filter__item__input">
													<el-input v-model="formInline.Content" placeholder="请输入您要检索的文献内容"
														clearable />
												</div>
											</div>
												...
												<div class="blog_details">
													<div class="anlicss">
														...
														<div class="btnanli02">
															...
															<div class="btn btn-ans"><a :href="config.CONFIG_API+ page.File">下载</a></div>
														</div>
													</div>
													<p>{{ page.Description }}
													</p>
													...
													<ul class="blog-info-link">
														<li><a href="#"><i
																	class="fa fa-comments"></i>{{ page.PublishOrganization }}</a>
														</li>
														<li><a href="#"><i
																	class="fa fa-users"></i>{{ page.Translator }}</a></li>
														<li><a href="#"><i
																	class="fa fa-calendar-times"></i>{{ page.PublishTime?.split('T')[0] }}</a>
														</li>
													</ul>
												</div>
											</article>
