							...
							<div class="single-post">
								...
								<div class="blog_details">
									...
									<ul class="blog-info-link mt-3 mb-4">
										<li><i class="fa fa-users"></i>{{detail.Author}}</li>
										<li><i class="fa fa-comments"></i>{{detail.Types}}</li>
									...
									<div class="row">
										...
										<div
											...
											<div v-if="next" class="detials">
												<p>下一篇</p>
												<a :href="'/theorydetails?id='+next.ID">
													<h4>{{next.Topic}}</h4>
												</a>
											</div>
											<div class="arrow">
...
import { getTagList, getList, getHomeList,getById } from "@/api/theory";
